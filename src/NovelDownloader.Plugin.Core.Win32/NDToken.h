...
NOVELDOWNLOADERPLUGINCOREWIN32_API HNDTOKEN APIENTRY NDToken_Parent(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API HNDTOKEN* APIENTRY NDToken_Children(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API LPCTSTR APIENTRY NDToken_Type(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API LPCTSTR APIENTRY NDToken_Title(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API LPCTSTR APIENTRY NDToken_Description(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API LPCTSTR APIENTRY NDToken_Uri(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API EventHandler* APIENTRY NDToken_CreepStarted(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API EventHandler* APIENTRY NDToken_CreepFetched(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API EventHandler* APIENTRY NDToken_CreepFinished(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API EventHandler* APIENTRY NDToken_CreepErrored(HNDTOKEN);

NOVELDOWNLOADERPLUGINCOREWIN32_API bool APIENTRY NDToken_CanStartCreep(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API void APIENTRY NDToken_StartCreep(HNDTOKEN);
//NOVELDOWNLOADERPLUGINCOREWIN32_API void NDToken_StartCreepInternal(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API bool APIENTRY NDToken_CanCreep(HNDTOKEN, void*);
NOVELDOWNLOADERPLUGINCOREWIN32_API void APIENTRY NDToken_Creep(HNDTOKEN, void*);
//NOVELDOWNLOADERPLUGINCOREWIN32_API bool NDToken_CreepInternal(HNDTOKEN);
NOVELDOWNLOADERPLUGINCOREWIN32_API void APIENTRY NDToken_OnCreepStarted(HNDTOKEN, void*, void*);
NOVELDOWNLOADERPLUGINCOREWIN32_API void APIENTRY NDToken_OnCreepFetched(HNDTOKEN, void*, void*);
NOVELDOWNLOADERPLUGINCOREWIN32_API void APIENTRY NDToken_OnCreepFinished(HNDTOKEN, void*, void*);
NOVELDOWNLOADERPLUGINCOREWIN32_API void APIENTRY NDToken_OnCreepErrored(HNDTOKEN, void*, void*);
#if defined __cplusplus & defined C_EXPORTS
}
#endif
